...
def train_weighted_bc(dataset, obs_dim, act_dim, num_epochs=50, batch_size=8, lr=1e-3, policy_type="deterministic", log_dir=None, save_epoch=50):
    ...
    for epoch in range(num_epochs):
        ...
        if epoch % save_epoch == 0:
            if log_dir:
                ...
                export_to_onnx(policy, obs_dim, export_path=os.path.join(log_dir, f"trained_BC_policy_{epoch}.onnx"))
...
if __name__ == "__main__":
    ...
    dataset_base_dir = "/home/tp2/Documents/kejia/clip_fixing_dataset/off_policy/"
